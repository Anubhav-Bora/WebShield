        ...
        <main className="min-h-screen bg-slate-900 p-8">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-4xl font-bold text-white mb-2">Create Provider</h1>
                ...
                <div className="bg-slate-800 rounded-lg border border-slate-700 p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex gap-4 pt-4">
                            ...
                            <Link
                                href="/providers"
                                className="flex-1 px-6 py-2 bg-slate-700 text-white rounded-lg font-semibold hover:bg-slate-600 transition text-center"
                            >
                                Cancel
                            </Link>
                        </div>
